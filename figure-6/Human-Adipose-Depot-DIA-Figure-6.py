...
axs.scatter(data=principal_components_with_raw, x='PC1', y='PC2', c=principal_components_with_raw['tissue_type'].map({'OM':[153/255,0/255,0/255], 'SQ':[0/255,76/255,153/255]}))
axs.set_xlabel("Principal Component 1 (20.0%)", size = 18)
axs.set_ylabel("Principal Component 2 (13.1%)", size = 18)
axs.legend(handles=[
    mpatches.Patch(color=[0/255,76/255,153/255] , label='SQ'),
...
plotEllipse(x=principal_components_with_raw[principal_components_with_raw.tissue_type == 'SQ']['PC1'], 
    y = principal_components_with_raw[principal_components_with_raw.tissue_type == 'SQ']['PC2'], 
...
plt.savefig('figure-6a.png', dpi=1200, bbox_inches='tight')
plt.clf()
...
plt.title('OM Adipose Tissue',fontsize = 14)
plt.legend(loc='upper right',fontsize = 12)

plt.xticks(fontsize=12)
plt.yticks(fontsize=12)

plt.text(x=3700, y=10.5, s='4799 proteins', fontsize=12, color=[153/255,0,0])

plt.savefig('figure-6b.pdf',dpi=1200, bbox_inches='tight')
plt.savefig('figure-6b.png',dpi=1200, bbox_inches='tight')
...
plt.xlabel("Rank",fontsize = 14)
plt.ylabel('Log$_{10}$ protein peak area',fontsize = 14)
plt.title('SQ Adipose Tissue',fontsize = 14)
plt.legend(loc='upper right',fontsize = 12)

plt.xticks(fontsize=12)
plt.yticks(fontsize=12)

plt.text(x=3700, y=10.5, s='4799 proteins', fontsize=12, color=[0,76/255,153/255])

plt.savefig('figure-6c.pdf',dpi=1200, bbox_inches='tight')
plt.savefig('figure-6c.png',dpi=1200, bbox_inches='tight')
plt.clf()