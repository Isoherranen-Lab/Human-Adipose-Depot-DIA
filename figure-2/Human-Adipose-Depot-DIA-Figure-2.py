...
plt.scatter(data=adipocyte_data, x='BMI', y='SCLogArea', s=adipocyte_data['SC Weight']*1000, color=[0/255,76/255,153/255],label="SQ")
...
plt.legend(handles = handles[::-1], labels=['SQ (p = 0.017)','OM (p = 0.023)'], fontsize=13, loc='upper left', handletextpad=0.2)

plt.savefig('figure-2b.pdf',dpi=1200, bbox_inches='tight')
plt.savefig('figure-2b.png',dpi=1200, bbox_inches='tight')
plt.clf()
...
plt.savefig('figure-2c.png',dpi=1200, bbox_inches='tight')